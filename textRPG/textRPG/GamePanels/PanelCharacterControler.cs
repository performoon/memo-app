...
namespace textRPG
{
    class PanelCharacterControler : GamePanelParent
    {
        public PanelCharacterControler(Form addForm, string useTable) : base(addForm, "characterPanelTest", Color.Yellow, useTable)
        {
            ...
            try
            {
                ...
                using (connection = new SqlConnection(builder.ConnectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        string sqlstr = string.Format("SELECT * from {0}", useAreaTable);
